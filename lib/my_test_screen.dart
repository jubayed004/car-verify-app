...
class WorkScheduleDownloadScreen extends StatelessWidget {
  WorkScheduleDownloadScreen({super.key});
  ...
  Future<List<pw.ImageProvider>> _loadImages() async {
    ...
    final ByteData data1 =
        await rootBundle.load('assets/images/fontbamper.png');
  ...
  final PdfColor containerColor = PdfColor.fromInt(0xffE5F4FF); // ✅ Blue Header
  final PdfColor textColor = PdfColor.fromInt(0xff7A7A7A); // ✅ Blue Header
  final PdfColor n2 = PdfColor.fromInt(0xff6F6F6F); // ✅ Blue Header
                           ...
                           child: pw.Row(children: [
                             pw.Text("Disclaimer",
                                 style: pw.TextStyle(
                                     ...
                                     color: appColor)),
                             pw.SizedBox(width: 8),
                             pw.Image(images[1], width: 14, height: 14),
                             pw.SizedBox(height: 6),
                           ])),
                       pw.SizedBox(height: 10),
                       pw.Text(
