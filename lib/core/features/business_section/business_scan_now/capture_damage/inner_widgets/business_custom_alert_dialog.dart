...
class BusinessCaptureCustomAlertDialog extends StatefulWidget {
  const BusinessCaptureCustomAlertDialog({super.key});

  @override
  _BusinessCaptureCustomAlertDialogState createState() =>
      _BusinessCaptureCustomAlertDialogState();
}

class _BusinessCaptureCustomAlertDialogState extends State<BusinessCaptureCustomAlertDialog> {
