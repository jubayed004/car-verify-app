    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            CustomText(text: "Registration no",fontWeight: FontWeight.w600,fontSize: 16,bottom: 8,),
            CustomTextField(hintText: "Type here....",fillColor: Colors.white,hintStyle: TextStyle(fontSize: 16)),
            SizedBox(height: 14.h),
            CustomText(text: "Model ",fontWeight: FontWeight.w600,fontSize: 16,bottom: 8,),
            CustomTextField(hintText: "Type here....",fillColor: Colors.white,hintStyle: TextStyle(fontSize: 16)),
            SizedBox(height: 14.h),
            CustomText(text: "Vehicle year ",fontWeight: FontWeight.w600,fontSize: 16,bottom: 8,),
            CustomTextField(hintText: "Type here....",fillColor: Colors.white,hintStyle: TextStyle(fontSize: 16)),
            SizedBox(height: 14.h),
