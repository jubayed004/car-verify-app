...
class EmployeePreVerificationTab extends StatelessWidget {
  const EmployeePreVerificationTab({super.key});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
       CustomGradientButton(text: "Compare now", onPressed: (){Get.toNamed(AppRoutes.employeeViewReportsScreen);}),
