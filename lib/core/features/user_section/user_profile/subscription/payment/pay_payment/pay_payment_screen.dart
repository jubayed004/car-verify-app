...
import 'package:car_verify_app/core/features/user_section/user_profile/subscription/payment/payment_successful/payment_successful_screen.dart';
import 'package:car_verify_app/core/utils/app_colors/app_colors.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class UserPayPaymentScreen extends StatelessWidget {
  const UserPayPaymentScreen({super.key});
        ...
        child: Column(
          ...
          CustomText(text: "Enter Card Details",fontWeight: FontWeight.w600,fontSize: 18.sp,bottom: 20,),
            ...
            CustomGradientButton(text: "Pay",
                onPressed: (){
              Get.to(UserPaymentSuccessfulScreen());
                },
