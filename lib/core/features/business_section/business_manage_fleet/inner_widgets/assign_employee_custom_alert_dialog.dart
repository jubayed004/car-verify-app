...
class AssignEmployeeCustomAlertDialog extends StatefulWidget {
  const AssignEmployeeCustomAlertDialog({super.key});

  @override
  _AssignEmployeeCustomAlertDialogState createState() => _AssignEmployeeCustomAlertDialogState();
}

class _AssignEmployeeCustomAlertDialogState extends State<AssignEmployeeCustomAlertDialog> {
