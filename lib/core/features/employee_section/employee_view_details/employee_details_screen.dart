...
import 'package:car_verify_app/core/features/employee_section/employee_view_details/inner_widgets/employee_post_verification_tab.dart';
import 'package:car_verify_app/core/features/employee_section/employee_view_details/inner_widgets/employee_pre_verification_tab.dart';
...
class EmployeeViewDetailsScreen extends StatelessWidget {
  EmployeeViewDetailsScreen({super.key});
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const BusinessInfoRow(title: 'Inspected by : ', value: 'You'),
            SizedBox(height: 14),
            Padding(
            ...
            Obx(() {
              if (controller.selectedTabIndex.value == 0) {
                return const EmployeePreVerificationTab();
              } else {
                return EmployeePostVerificationTab();
              }
            }),
